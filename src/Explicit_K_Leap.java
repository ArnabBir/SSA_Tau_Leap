...
public class Explicit_K_Leap {
    ...
    public static void main(String[] args) throws IOException {
        ...
        FileWriter writer = new FileWriter("Explicit_Tau_Leap.csv");
...

            {
                ...
                if (tao_dash < tao_2dash) {
                   ...
                   // System.out.println("Knc = " + Knc);
                    ...
                    if (not_critical < REACTIONS) {
                        ...
                        System.out.println("Kc = " + K_critical);
                ...
                if (tao_dash > tao_2dash) {
                    ...
                    if (critical != REACTIONS) {
                        ...
                        System.out.println("Knc = " + K_not_critical);

...
//        String xyz = sc.nextLine();
        ...
        FileWriter writer = new FileWriter("SC1_CI_Multistep_Binomial_Leap.csv");
        ...
        while (steps < 10000000) {
            ...
            while ( a0 * tao / (double) REACTIONS + 1.96 / (double) Math.sqrt(REACTIONS) * Math.sqrt( a0 * tao /(double) REACTIONS ) >=  L_min) {
...
//                tao *= tao;
            ...
            System.out.println("New tao = " + tao);
